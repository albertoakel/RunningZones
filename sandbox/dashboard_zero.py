...
## corrigindo leitura de dados.
#programa só carrega caminho aboluto.
...
def dash_01():
    ...
    print(f"O script '{os.path.basename(__file__)}' está sendo executado de: {os.getcwd()}")
    print(f"Caminho absoluto do script: {os.path.abspath(__file__)}")
    #print(f"Diretório do script: {script_dir}")
    print(f"Tentando carregar dados do caminho construído: {path_files}")
